    ...
    <header id="header">
            ...
            <? if(isset($_SESSION['one_variation']) ): ?>
                        ...
                        <div class="header__item" data-v-78ac9c45="">
                            ...
                            <?=$lang_product['product_fr']?>
                            </div>
                            <div class="header__item-subname" data-v-78ac9c45="">
                                Acheté des produits peu ou pas appropriés? <a href="mailto:support@eurodopadel.es" data-v-78ac9c45="">support@eurodopadel.es</a></div>
                        </div>
                    </div>
                <? endif; ?>
        </header>
        <div class="container">
            <div class="main">
                <h1 class="main-title main-title-index2 main-title-extra">Remplissez le formulaire et obtenez votre
                    produit gratuit
                </h1>
                <p class="main-desc-extra main-desc-extra666 cld2">Livraison gratuite | Sans commissions | Carte
                    bancaire non requise</p>
            </div>
        </div>
            ...
            <div class="container sport-cont">
                <div class="d-flex sport-container">
                    ...
                    <form action="<?=$form_link?>" method='POST' id="form">
                            <input type="text" class="input-field" required name="name" placeholder="Nom">
                            <input type="email" class="input-field" required name="email" placeholder="E-mail">
                            <p class="form-required-txt">*Veuillez entrer l'adresse à laquelle vous souhaitez envoyer un
                                cadeau
                            </p>
                            <input type="text" class="input-field" required name="address" placeholder="Adresse complète">
                            <input type="text" class="input-field" required name="city" placeholder="Ville">
                            <input type="text" class="input-field" required name="state" placeholder="État / province">
                            <input type="tel" class="input-field" required name="index" placeholder="Code postal">
                            ...
                            <input type="tel" class="input-field" required name="phone" placeholder="Numéro de téléphone">
                            <input type="text" class="input-field" required name="number" placeholder="Numéro de commande Amazon">
                            <p class="form-required-txt form-required-txt-extra">
                                Vérifiez l'historique des commandes <a href="#">dans le compte Amazon, dans votre boîte
                                    mail ou votre reçu</a>, obtenu avec le produit.
                                Par exemple 112-5465666-4343658
                            </p>
                            <div class="d-flex country-container free-gift-container">
                                ...
                                <div class="select-body" style="display: none;">
                                    ...
                                    <div class="select__child select-choose">Corde à sauter Orange</div>
                                    <div class="select__child select-choose active">Corde à sauter Vert</div>
                                </div>
                            </div>
                            <div class="form-btn-parent">
                                <button class="form-btn">Obtenir un cadeau</button>
                            </div>
                            <p class="form-required-txt privacy-policy-txt">
                                *Nous ne partageons jamais vos informations personnelles. Voici notre <a href="#">politique de
                                confidentialité</a>.
                            </p>
                            <p class="form-required-txt form-required-txt-extra">
                                *Pour passer à la qualification du produit, les participants acceptent de nous envoyer
                                leur expérience avec le produit
                                précédemment acquis, qu'ils utilisent activement au moins 14 jours.
                            </p>
        ...
        <div class="container">
            <h3 class="content-title spoort-title">REMPLISSEZ LE FORMULAIRE ET OBTENEZ VOTRE PRODUIT GRATUIT</h3>
            <div class="row free-product-container">
                <div class="free-product">
                    ...
                    <h4 class="free-product-title">1. REMPLISSEZ LE FORMULAIRE EN LIGNE</h4>
                    <p class="free-product-desc">
                        La première étape pour obtenir UN PRODUIT GRATUIT est de remplir le formulaire sur cette page.
                        L'offre est valable
                        uniquement pour les clients qui ont acheté nos produits au coût de notre vendeur officiel sur
                        Amazon.
                    </p>
                </div>
                <div class="free-product">
                    ...
                    <h4 class="free-product-title">2. PARTAGEZ VOTRE EXPÉRIENCE</h4>
                    <p class="free-product-desc">
                        Après avoir rempli le formulaire, nous vous demanderons de partager votre expérience
                        d'utilisation de notre produit.
                        L'envoi de votre avis aidera les autres clients à prendre une décision d'achat plus correcte.
                    </p>
                </div>
                <div class="free-product">
                    <div class="product-icon">
                    ...
                    <h4 class="free-product-title">3. OBTENEZ UN CADEAU</h4>
                    <p class="free-product-desc">
                        Si vous faites une demande pour un CADEAU excellent, nous vous l'enverrons dans les 48 heures.
                        Oui, nous allons payer le
                        produit, ainsi que la livraison - c'est gratuit pour vous!
                    </p>
                </div>
            </div>
        </div>
        <div class="container">
            <h3 class="content-title content-title33 content-title-extra">Livraison gratuite | Sans commissions | Carte
                bancaire non requise</h3>
            <div class="content-desc">
                <p class="content-desc-txt">* Les conditions s’appliquent :</p>
                <p class="content-desc-txt">
                    Limité par un produit gratuit sur le compte Amazon sur la famille. La proposition n'est valable que
                    pour les clients qui
                    ont acheté nos produits à un coût de notre vendeur officiel sur Amazon. Pour passer à la
                    qualification du produit, les
                    participants acceptent de nous envoyer leur expérience avec le produit précédemment acquis, qu'ils
                    utilisaient
                    activement pendant au moins 14 jours.
                </p>
            </div>
        </div>
        <div class="questions">
            <div class="container">
                <h3 class="questions-title">Questions fréquemment posées</h3>
                <div class="row question-container">
                    <div class="questions-block">
                        <div class="questions-block-title">Est-ce que c`est VRAIMENT un bon plan? Ou dois-je payer?
                        </div>
                        <p class="questions-block-desc">
                            Absolument aucun paiement. Nous ne demandons pas vos données de carte de crédit. Il n'y a
                            pas de version d'évaluation,
                            d'abonnements, de commissions cachées et de frais d'expédition. Nous couvrons tous les
                            coûts. C'est vraiment gratuit.
                        </p>
                    </div>
                    <div class="questions-block">
                        <div class="questions-block-title">Quel est le PIÈGE? Dois-je faire quelque chose?</div>
                        <p class="questions-block-desc">
                            La seule chose que nous demandons est de nous envoyer votre expérience des biens achetés.
                            Votre expérience nous aidera à
                            améliorer nos produits et aidera les autres clients à prendre une décision plus correcte.
                        </p>
                    </div>
                    <div class="questions-block">
                        <div class="questions-block-title">Quelles sont les conditions de participation ?</div>
                        <p class="questions-block-desc">
                            L'offre n'est valable que pour les clients qui ont acheté nos produits à un coût sur Amazon.
                            Vous devez profiter du
                            produit pendant au moins 14 jours avant de partager votre expérience.
                        </p>
                    </div>
                    <div class="questions-block">
                        <div class="questions-block-title">Combien de temps faut-il pour obtenir mon produit GRATUIT ?
                        </div>
                        <p class="questions-block-desc">
                            Si vous avez le droit à un produit gratuit, nous l'enverrons dans les 48 heures. Vous
                            recevrez un produit dans les 20-25
                            jours ouvrables.
                        </p>
                    </div>
                </div>
