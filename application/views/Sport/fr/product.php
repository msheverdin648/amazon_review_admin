<div id="full-page">
        ...
        <div class="container">
            ...
            <span id="amazon-url" style="display: none;">www.amazon<?=$marketplace_link?></span>
                <h1 class="main-title main-title-extra title-extra-style">Comment souhaitez-vous évaluer un produit?</h1>
                <div class="stars">
            ...
            <div class="product-last-text">* S'il vous plaît envoyez un retour honnête pour obtenir un produit
                gratuit!<br> * PAS de méthode de carte de crédit ou de
                paiement, juste votre avis est nécessaire.</div>
        </div>
