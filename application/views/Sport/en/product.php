<div id="full-page">
        ...
        <div class="container">
            ...
            <h1 class="main-title main-title-extra title-extra-style">How would you rate the product?</h1>               
            <div class="stars">
            ...
            <div class="product-last-text">*Please submit your honest feedback in order to receive your FREE
                Product!<br>
                *NO credit card or payment option required, just your helpful opinion.</div>
        </div>
