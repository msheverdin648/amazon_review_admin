...
?>
    ...
    <header id="header">
            ...
            <? if(isset($_SESSION['one_variation']) ): ?>
                        ...
                        <div class="header__item" data-v-78ac9c45="">
                            ...
                            <div class="header__item-name" data-v-78ac9c45="">
                                <?=$lang_product['product_en']?>
                            </div>
                            <div class="header__item-subname" data-v-78ac9c45="">
                                Don't see the item you bought? <a href="mailto:support@eurodopadel.es" data-v-78ac9c45="">support@eurodopadel.es</a></div>
                        </div>
                    </div>
                <? endif; ?>
        </header>
        <div class="container">
            <div class="main">
                <h1 class="main-title main-title-index2 main-title-extra">Fill out the form and get your free product
                </h1>
                <p class="main-desc-extra main-desc-extra666 cld2">No Shipping Charges | No Hidden Fees | No Credit Card
                    Required</p>
            </div>
        </div>
            ...
            <div class="container sport-cont">
                <div class="d-flex sport-container">
                    ...
                    <? foreach ($presents as $key => $present) : ?>
                        ...
                        <? endforeach; ?>
                        <div class="sport-item">
                            <p class="sport-item-desc">
                                * Limited to one free product per Amazon account per household. The offer is only
                                available for customers that purchased
                                the produst at full price through our official seller at Amazon.
                            </p>
                        </div>
                    </div>
                    <div class="sport-form">
                    <form action="<?=$form_link?>" method='POST' id="form">
                            <input type="text" class="input-field" required name="name" placeholder="Full Name">
                            <input type="email" class="input-field" required name="email" placeholder="E-mail Address">
                            <p class="form-required-txt">* Please input the address where you want the gift to be sent.
                            </p>
                            <input type="text" class="input-field" required name="address" placeholder="Full Address">
                            <input type="text" class="input-field" required name="city" placeholder="City Name">
                            <input type="text" class="input-field" required name="state" placeholder="State / Province">
                            <input type="tel" class="input-field" required name="index" placeholder="Zip Code">
                            ...
                            <input type="tel" class="input-field" required name="phone" placeholder="Phone Number">
                            <input type="text" class="input-field" required name="number" placeholder="Amazon Order #">
                            <p class="form-required-txt form-required-txt-extra">
                                * Check in your <a href="#"> Amazon Account Order History</a>, in your email or in the
                                receipt you received with
                                your product. E.g. 112-5465666-4343658
                            </p>
                            <div class="d-flex country-container free-gift-container">
                                <select class="input-field" name="id_gift">
                                    <option>Choose your free gift</option>
                                    <? foreach ($presents as $key => $present) : ?>
                                ...
                                <div class="select-body" style="display: none;">
                                    ...
                                    <div class="select__child select-choose">Skipping rope Orange</div>
                                    <div class="select__child select-choose active">Skipping rope Green</div>
                                </div>
                            </div>
                            <div class="form-btn-parent">
                                <button class="form-btn">Get a gift</button>
                            </div>
                            <p class="form-required-txt privacy-policy-txt">
                                * We will never share your personal information with anyone. Here is our <a href="#">
                                    privacy policy</a>.
                            </p>
                            <p class="form-required-txt form-required-txt-extra">
                                * To qualify, participants agree to send us their experience with the previously
                                purchased product that they have been ACTIVELY USING FOR AT LEAST 14 DAYS.
                            </p>
        ...
        <div class="container">
            <h3 class="content-title spoort-title">FILL OUT THE FORM AND GET YOUR FREE PRODUCT</h3>
            <div class="row free-product-container">
                <div class="free-product">
                    ...
                    <h4 class="free-product-title">1. FILL IN THE ONLINE FORM</h4>
                    <p class="free-product-desc">
                        The first step to receive your FREE PRODUCT is to complete the form on this page. The offer is
                        valid only for customers that
                        bought the product at full price through our official seller at Amazon.
                    </p>
                </div>
                <div class="free-product">
                    <div class="product-icon">
                    ...
                    <h4 class="free-product-title">2. SHARE YOUR EXPERIENCE</h4>
                    <p class="free-product-desc">
                        After filling the form we will ask about your experience with our product. Sharing your feedback
                        will help other
                        customers make a better purchase decision.
                    </p>
                </div>
                <div class="free-product">
                    <div class="product-icon">
                    ...
                    <h4 class="free-product-title">3. RECEIVE A GIFT</h4>
                    <p class="free-product-desc">
                        If you qualify for an Awesome GIFT, we will ship it within 48h. Yes, we will pay for the product
                        and for shipping
                        too - zero cost for you!
                    </p>
                </div>
            </div>
        </div>
        <div class="container">
            <h3 class="content-title content-title33 content-title-extra">No Shipping Charges | No Hidden Fees | No
                Credit Card Required</h3>
            <div class="content-desc">
                <p class="content-desc-txt">* Conditions apply:</p>
                <p class="content-desc-txt">
                    Limited to one free product per Amazon account per household. The offer is only available for
                    customers that purchased the product
                    at full price through our official seller at Amazon. To qualify, participants agree to send us their
                    experience with the
                    previously purchased product that they have been actively using for at least 14 days.
                </p>
            </div>
        </div>
        <div class="questions">
            <div class="container">
                <h3 class="questions-title">Frequently Asked Questions</h3>
                <div class="row question-container">
                    <div class="questions-block">
                        <div class="questions-block-title">Is it REALLY free? Or do I have to pay?</div>
                        <p class="questions-block-desc">
                            There are absolutely no charges. We're not asking for your credit card details at any point.
                            There's no trial, no
                            subscription, no hidden fees, no shipping fees. We cover all the costs. This is TRULY FREE.
                        </p>
                    </div>
                    <div class="questions-block">
                        <div class="questions-block-title">What's the CATCH? Do I need to do something?</div>
                        <p class="questions-block-desc">
                            The only thing we ask is that you send us your experience with the product. Sharing your
                            experience will help us
                            improve our products and it will help other customers make a better decision.
                        </p>
                    </div>
                    <div class="questions-block">
                        <div class="questions-block-title">What are the CONDITIONS to qualify?</div>
                        <p class="questions-block-desc">
                            The offer is only valid for customers who purchased the product at full price on Amazon. You
                            also need to use the product
                            for at least 14 days before sharing your experience.
                        </p>
                    </div>
                    <div class="questions-block">
                        <div class="questions-block-title">HOW LONG will it take to receive my Free Item?</div>
                        <p class="questions-block-desc">
                            If you qualify for a FREE product we will ship it within 48h. You will receive the product
