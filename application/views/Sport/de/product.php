<div id="full-page">
        ...
        <div class="container">
            ...
            <h1 class="main-title main-title-extra title-extra-style">Wie würden Sie das Produkt bewerten?</h1>           
            <div class="stars">
            ...
            <div class="product-last-text">* Bitte senden Sie Ihr ehrliches Feedback, um Ihr KOSTENLOSES Produkt zu
                bekommen!
                * KEINE Kreditkarte oder Zahlungsoption erforderlich, nur Ihre hilfreiche Meinung.
            </div>
        </div>
