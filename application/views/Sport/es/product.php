<div id="full-page">
        ...
        <div class="container">
            ...
            <h1 class="main-title main-title-extra title-extra-style">¿Cómo le gustaría evaluar este producto?</h1>
            <div class="stars">
            ...
            <div class="product-last-text">* Envíe una reseña honesta para obtener un producto GRATIS.<br>
                * SIN tarjeta de crédito ni método de pago, solo su útil opinión .</div>
        </div>
