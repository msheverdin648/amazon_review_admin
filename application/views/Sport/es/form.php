    ...
    <header id="header">
            ...
            <? if(isset($_SESSION['one_variation']) ): ?>
                        ...
                        <div class=" header__subtitle" data-v-78ac9c45="">
                            Usted ha comprado este artículo
                        </div>
                        <div class="header__item" data-v-78ac9c45="">
                            ...
                            <div class="header__item-name" data-v-78ac9c45="">
                                <?=$lang_product['product_es']?>
                            </div>
                            <div class="header__item-subname" data-v-78ac9c45="">
                                ¿No compró este artículo? Escríbenos a correo electrónico <a href="mailto:support@eurodopadel.es" data-v-78ac9c45="">support@eurodopadel.es</a></div>
                        </div>
                    </div>
                <? endif; ?>
        </header>
        <div class="container">
            <div class="main">
                <h1 class="main-title main-title-index2 main-title-extra">Complete el formulario y reciba su producto
                    gratis
                </h1>
                <p class="main-desc-extra main-desc-extra666 cld2">Envío Gratis | Sin comisiones | No se requiere
                    tarjeta bancaria</p>
            </div>
        </div>
            ...
            <div class="container sport-cont">
                <div class="d-flex sport-container">
                    <div class="sport-product-img d-flex">
                        ...
                        <? endforeach; ?>
                        <div class="sport-item">
                            <p class="sport-item-desc" style="padding-top:410px">
                    ...
                    <form action="<?=$form_link?>" method='POST' id="form">
                            <input type="text" class="input-field" required name="name" placeholder="Nombre">
                            <input type="email" class="input-field" required name="email" placeholder="e-mail">
                            <p class="form-required-txt">* Introduzca la dirección para enviar el regalo
                            </p>
                            <input type="text" class="input-field" required name="address" placeholder="Dirección completa">
                            <input type="text" class="input-field" required name="city" placeholder="Ciudad">
                            <input type="text" class="input-field" required name="state" placeholder="Provincia">
                            <input type="tel" class="input-field" required name="index" placeholder="Сódigo postal">
                            ...
                            <input type="tel" class="input-field" required name="phone" placeholder="Número de teléfono">
                            <input type="text" class="input-field" required name="number" placeholder="Número de pedido en Amazon">
                            <p class="form-required-txt form-required-txt-extra">
                                * Consulta el historial <a href="#"> de pedidos de tu cuenta de Amazon</a>, envía un
                                correo electrónico o el recibo recibido con el
                                producto. Por ejemplo, 112-5465666-4343658
                            </p>
                            <div class="d-flex country-container free-gift-container">
                                ...
                                <div class="select-body" style="display: none;">
                                    ...
                                    <div class="select__child select-choose">Cuerda para Saltar Naranja</div>
                                    <div class="select__child select-choose active">Cuerda para Saltar Verde</div>
                                </div>
                            </div>
                            <div class="form-btn-parent">
                                <button class="form-btn">Recibe el regalo</button>
                            </div>
                            <p class="form-required-txt privacy-policy-txt">
                                * Nunca compartimos información personal de nuestros usuarios con nadie. Aquí está
                                nuestra <a href="#">política de privacidad.</a>.
                            </p>
                            <p class="form-required-txt form-required-txt-extra">
                                * Para calificar, los participantes deben aceptar enviarnos su experiencia con un
                                producto comprado previamente y que
                                HAN USADO DURANTE AL MENOS 14 DÍAS.
                            </p>
        ...
        <div class="container">
            <h3 class="content-title spoort-title">Complete el formulario y reciba su producto gratis</h3>
            <div class="row free-product-container">
                <div class="free-product">
                    ...
                    <h4 class="free-product-title">1. LLENE EL FORMULARIO EN LÍNEA</h4>
                    <p class="free-product-desc">
                        El primer paso para obtener un PRODUCTO GRATIS es completar el formulario en esta página. La
                        oferta solo es válida para
                        los clientes que hayan comprado el artículo a precio completo en nuestro distribuidor autorizado
                        en Amazon.com.
                    </p>
                </div>
                <div class="free-product">
                    ...
                    <h4 class="free-product-title">2. COMPARTA SU EXPERIENCIA</h4>
                    <p class="free-product-desc">
                        Después de completar el formulario, le preguntaremos sobre su experiencia con nuestro producto.
                        Enviar sus comentarios
                        ayudará a otros clientes a tomar mejores decisiones de compra.
                    </p>
                </div>
                <div class="free-product">
                    <div class="product-icon">
                    ...
                    <h4 class="free-product-title">3. OBTENGA UN REGALO</h4>
                    <p class="free-product-desc">
                        Si reclama un regalo grande le será enviado en un plazo de 48 horas. Nos hacemos cargo de los
                        gastos de envío. ¡Para
                        usted el coste es 0!
                    </p>
                </div>
            </div>
        ...
        <div class="container">
            <h3 class="content-title content-title33 content-title-extra">Envío Gratis | Sin comisiones | No se requiere
                tarjeta bancaria</h3>
            <div class="content-desc">
                <p class="content-desc-txt">* Las condiciones se aplican:</p>
                <p class="content-desc-txt">
                    Limitado a un producto gratuito por cuenta de Amazon por hogar. Oferta válida solo para clientes que
                    hayan comprado
                    nuestro artículo a precio completo en nuestro minorista oficial de Amazon.com. Para calificar, los
                    participantes deben
                    aceptar enviarnos su experiencia con un producto comprado previamente y que han usado durante al
                    menos 14 días.
                </p>
            </div>
        </div>
        <div class="questions">
            <div class="container">
                <h3 class="questions-title">Preguntas frecuentes</h3>
                <div class="row question-container">
                    <div class="questions-block">
                        <div class="questions-block-title">¿Es REALMENTE gratis? ¿O tengo que pagar?</div>
                        <p class="questions-block-desc">
                            No hay absolutamente ninguna tarifa. No solicitamos los datos de su tarjeta de crédito de
                            ninguna manera. Sin
                            suscripción, sin tarifas ocultas o tarifas de envío. Cubrimos todos los gastos. Es REALMENTE
                            GRATIS.
                        </p>
                    </div>
                    <div class="questions-block">
                        <div class="questions-block-title">¿Cuál es el truco? ¿Necesito hacer algo?</div>
                        <p class="questions-block-desc">
                            Lo único que te pedimos es que nos envíes tu experiencia con el producto. Compartir sus
                            experiencias nos ayudará a
                            mejorar nuestros productos y ayudará a otros clientes a tomar mejores decisiones.
                        </p>
                    </div>
                    <div class="questions-block">
                        <div class="questions-block-title">¿Cuáles son las CONDICIONES de participación?</div>
                        <p class="questions-block-desc">
                            Oferta válida solo para clientes que compraron el producto a precio completo en Amazon.com.
                            También debe usarlo durante
                            al menos 14 días antes de compartir su experiencia.
                        </p>
                    </div>
                    <div class="questions-block">
                        <div class="questions-block-title">¿Cuánto tiempo tardaré en recibir mi artículo gratis?</div>
                        <p class="questions-block-desc">
                            Si selecciona un producto GRATIS, lo enviaremos en 48 horas. Recibira su producto en un
                            plazo de 20 a 25 días hábiles.
                        </p>
                    </div>
                </div>
            </div>
