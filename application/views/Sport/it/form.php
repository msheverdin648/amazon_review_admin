...
?>
    <div id="full-page">
        <header id="header">
            ...
            <? if(isset($_SESSION['one_variation']) ): ?>
                        ...
                        <div class="header__item" data-v-78ac9c45="">
                            ...
                            <?=$lang_product['product_it']?>
                            </div>
                            <div class="header__item-subname" data-v-78ac9c45="">
                                Non vedi il prodotto che hai comprato? <a href="mailto:support@eurodopadel.es" data-v-78ac9c45="">support@eurodopadel.es</a></div>
                        </div>
                    </div>
                <? endif; ?>
        </header>
        <div class="container">
            <div class="main">
                <h1 class="main-title main-title-index2 main-title-extra">Compila il modulo e ottieni il tuo prodotto
                    gratuito
                </h1>
                <p class="main-desc-extra main-desc-extra666 cld2">Nessuna spesa di spedizione | Nessun costo nascosto |
                    Non è richiesta la carta di credito</p>
            </div>
        </div>
            ...
            <div class="container sport-cont">
                <div class="d-flex sport-container">
                    ...
                    <? foreach ($presents as $key => $present) : ?>
                        ...
                        <? endforeach; ?>
                        <div class="sport-item">
                            <p class="sport-item-desc" style="padding-top: 385px;">
                                *Limitato ad un prodotto gratuito per un account Amazon per famiglia. L'offerta è disponibile solo per i clienti che hanno acquistato il prodotto a prezzo pieno tramite il nostro venditore ufficiale su Amazon.
                            </p>
                        </div>
                    </div>
                    <div class="sport-form">
                        <form action="<?=$form_link?>" method='POST' id="form">
                            <input type="text" class="input-field" required name="name" required placeholder="Nome completo">
                            <input type="email" class="input-field" required name="email" placeholder="Indirizzo mail">
                            <p class="form-required-txt">*Per favore inserisci l'indirizzo presso cui vuoi che il regalo
                                venga spedito.
                            </p>
                            <input type="text" class="input-field" required name="address" placeholder="Indirizzo completo">
                            <input type="text" class="input-field" required name="city" placeholder="Nome della città">
                            <input type="text" class="input-field" required name="state" placeholder="Stato/Provincia">
                            <input type="tel" class="input-field" required name="index" placeholder="Codice Postale">
                            <div class="d-flex country-container">
                                <select id="country" class="input-field" name="country">
                                    <option value="<?=$country?>">Seleziona il Paese</option>
                            ...
                            <input type="tel" class="input-field" required name="phone" placeholder="Numero di telefono">
                            <input type="text" class="input-field" required name="number" placeholder="Ordine Amazon">
                            <p class="form-required-txt form-required-txt-extra">
                                * Controlla nella cronologia dei tuoi ordini del <a href="#">tuo account di Amazon</a>,
                                nella tua mail o nella ricevuta con il prodotto,
                                es. 112-5465666-4343658
                            </p>
                            <div class="d-flex country-container free-gift-container">
                                ...
                                <div class="select-body" style="display: none;">
                                    ...
                                    <div class="select__child select-choose">Corda per saltare Arancia</div>
                                    <div class="select__child select-choose active">Corda per saltare Verde</div>
                                </div>
                            </div>
                            <div class="form-btn-parent">
                                <button class="form-btn">Ottieni un regalo</button>
                            </div>
                            <p class="form-required-txt privacy-policy-txt">
                                *Non condivideremo mai le tue informazioni personali con nessuno. Questa è la nostra
                                <a href="#">politica della privacy</a>.
                            </p>
                            <p class="form-required-txt form-required-txt-extra">
                                *Per averne diritto, i partecipanti sono d'accordo nell'inviarci la loro esperienza con
                                il loro prodotto precedentemente
                                acquistato che stanno usando in maniera attiva per almeno 14 giorni.
                            </p>
        ...
        <div class="container">
            <h3 class="content-title spoort-title">COMPILA IL MODULO E OTTIENI IL PRODOTTO GRATUITO</h3>
            <div class="row free-product-container">
                <div class="free-product">
                    ...
                    <h4 class="free-product-title">1. COMPILA IL MODULO</h4>
                    <p class="free-product-desc">
                        Il primo passo per ricevere il tuo PRODOTTO GRATUITO è compilare tutto il modulo su questa
                        pagina. L'offerta è valida
                        solo per i clienti che hanno acquistato il prodotto a prezzo pieno tramite il nostro venditore
                        ufficiale su Amazon.
                    </p>
                </div>
                <div class="free-product">
                    ...
                    <h4 class="free-product-title">2. CONDIVIDI LA TUA ESPERIENZA</h4>
                    <p class="free-product-desc">
                        Dopo aver completato il modulo ti chiederemo la tua esperienza con il nostro prodotto. Nel
                        condividere la tua opinione
                        aiuterai gli altri clienti a prendere una migliore decisione.
                    </p>
                </div>
                <div class="free-product">
                    <div class="product-icon">
                    ...
                    <h4 class="free-product-title">3. RICEVI UN REGALO</h4>
                    <p class="free-product-desc">
                        Se ti candidi per un fantastico REGALO, te lo spediremo entro 48 ore. Sì, pagheremo il prodotto
                        e anche la spedizione,
                        zero costi per te!
                    </p>
                </div>
            </div>
        ...
        <div class="container">
            <h3 class="content-title content-title33 content-title-extra">Nessuna spesa di spedizione | Nessun costo
                nascosto | Non è richiesta la carta di credito</h3>
            <div class="content-desc">
                <p class="content-desc-txt">* Condizioni che si applicano:</p>
                <p class="content-desc-txt">
                    Limitato ad un prodotto gratuito per un account Amazon per famiglia. L'offerta è disponibile solo
                    per i clienti che
                    hanno acquistato il prodotto a prezzo pieno tramite il nostro venditore ufficiale su Amazon. per
                    avere i requisiti, i
                    partecipanti accettano di inviarci la loro esperienza con il prodotto acquistato in precedenza che
                    hanno utilizzato
                    attivamente per almeno 14 giorni.
                </p>
            </div>
        </div>
        <div class="questions">
            <div class="container">
                <h3 class="questions-title">Domande piú frequenti</h3>
                <div class="row question-container">
                    <div class="questions-block">
                        <div class="questions-block-title">È davvero gratuito? O devo pagare?</div>
                        <p class="questions-block-desc">
                            Non ci sono assolutamenti costi aggiunti. Non ti chiediamo per nessun motivo i dettagli
                            della tua carta di credito.
                            Nessuna prova, nessun abbonamento, nessun costo nascosto, nessun costo di spedizione.
                            Copriamo tutti i costi. Questo è
                            VERAMENTE GRATUITO.
                        </p>
                    </div>
                    <div class="questions-block">
                        <div class="questions-block-title">Cos'è il "CATCH"? Devo fare qualcosa?</div>
                        <p class="questions-block-desc">
                            L'unica cosa che ti chiediamo è di inviarci la tua esperienza con il prodotto. Nel
                            condividere la tua esperienza ci
                            aiuterai nel migliorare i nostri prodotti e ciò aiuterà gli altri clienti a prendere una
                            migliore decisione.
                        </p>
                    </div>
                    <div class="questions-block">
                        <div class="questions-block-title">Quali sono le CONDIZIONI per averne diritto?</div>
                        <p class="questions-block-desc">
                            L'offerta è disponibile solo per i clienti che hanno acquistato il prodotto a prezzo pieno
                            su Amazon. Devi inoltre usare
                            il prodotto per almeno 14 giorni prima di condividere la tua esperienza.
                        </p>
                    </div>
                    <div class="questions-block">
                        <div class="questions-block-title">QUANTO ci metterò a ricevere il mio articolo gratuito?</div>
                        <p class="questions-block-desc">
                            Se ti candidi per un prodotto GRATUITO te lo manderemo in 48 ore. Riceverai il prodotto
                            entro 20-25 giorni lavorativi.
                        </p>
                    </div>
                </div>
            </div>
