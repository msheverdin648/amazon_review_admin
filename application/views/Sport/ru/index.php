    ...
    <div id="full-page">
            ...
            <div class="header-container">
                <div class="container">
                    <a href="<?=$index_url?>" class="logo">
                        <img src="<? echo $baseURL."/img/logo.svg"?>" class="fluid-img" alt="Logo">
                    </a>
                </div>
            </div>
        </header>
        <div class="container">
            <div class="main main444">
                <h1 class="main-title main-title-first">Какой продукт вы купили?</h1>
                <p class="main-desc main-desc444">Купили не эти товары? <a href="#">Свяжитесь с нами +
