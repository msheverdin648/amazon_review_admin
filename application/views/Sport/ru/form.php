...
<div id="full-page">
        ...
        <? if(isset($_SESSION['one_variation']) ): ?>
                    ...
                    <div class="header__item" data-v-78ac9c45="">
                        ...
                        <div class="header__item-name" data-v-78ac9c45="">
                            <?=$lang_product['product_ru'] ?>
                        </div>
                        <div class="header__item-subname" data-v-78ac9c45="">
                            Купили не этот товар? <a href="#"> Свяжитесь с нами support@eurodo.es</a>
                    </div>
                </div>
            <? endif; ?>
    </header>
    <div class="container">
        <div class="main">
            <h1 class="main-title main-title-index2 main-title-extra">Заполните форму и получите ваш беспатный
                продукт</h1>
            <p class="main-desc-extra main-desc-extra666 cld2">Бесплатная доставка | Без комиссий | Не требуется
                банковская карта</p>
        </div>
    </div>
        ...
        <div class="container sport-cont">
            <div class="d-flex sport-container">
                <div class="sport-product-img d-flex">
                    ...
                    <? endforeach; ?>
                    <div class="sport-item">
                        <p class="sport-item-desc" style="padding-top: 360px;">
                            * Ограничено одним бесплатным продуктом на одну учетную запись Amazon на семью.
                            Предложение действительно только для
                            клиентов, которые приобрели товар по полной цене у нашего официального продавца на
                            Amazon.com.
                        </p>
                    </div>
                </div>
                <div class="sport-form">
                    <form action="<?=$form_link?>" method='post' >
                        <input type="text" class="input-field" required name="name" placeholder="Имя">
                        <input type="email" class="input-field" required name="email" placeholder="e-mail">
                        <p class="form-required-txt">* Пожалуйста, введите адрес, по которому вы хотите
                            отправить подарок"</p>
                        <input type="text" class="input-field" required name="address" placeholder="Полный адрес">
                        <input type="text" class="input-field" required name="city" placeholder="Город">
                        <input type="text" class="input-field" required name="state" placeholder="Штат / провинция">
                        <input type="tel" class="input-field" required name="index" placeholder="Индекс">
                        ...
                        <input type="tel" class="input-field" required name="phone" placeholder="Телефонный номер">
                        <input type="text" class="input-field" required name="number" placeholder="№ заказа Amazon">
                        <p class="form-required-txt form-required-txt-extra">
                            Проверьте в Истории Заказов в <a href="#"> Аккаунте Амазон,</a>, в своей электронной
                            почте или квитанции, полученной вместе с продуктом.
                            Например 112-5465666-4343658
                        </p>
                        ...
                        <div class="form-btn-parent">
                            <button class="form-btn" type="submit">Получить подарок</button>
                        </div>
                        <p class="form-required-txt privacy-policy-txt">
                            * Мы никогда никому не передадим вашу личную информацию. Вот наша <a href="#">политика
                                конфиденциальности </a>.
                        </p>
                        <p class="form-required-txt form-required-txt-extra">
                            * Чтобы пройти квалификацию, участники соглашаются присылать нам свой опыт работы с
                            ранее приобретенным продуктом,
                            который они АКТИВНО ИСПОЛЬЗУЮТ НЕ МЕНЕЕ 14 ДНЕЙ.
                        </p>
    ...
    <div class="container">
        <h3 class="content-title spoort-title">Заполните форму и получите ваш беспатный продукт</h3>
            ...
            <div class="free-product">
                <div class="product-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 226 226" fill="none">
                        ...
                        <path d="M76.5471 42.8406C65.9548 42.8406 55.3625 42.8406 44.7701 42.8406C42.8944 42.8406 41.4203 42.3375 40.8819 40.3471C40.211 37.8712 41.7381 35.9778 44.598 35.9337C50.1104 35.8631 55.6317 35.8984 61.1397 35.9028C76.5779 35.9028 92.0148 35.916 107.45 35.9425C107.891 35.9425 108.333 35.9425 108.774 35.9425C111.303 36.0705 112.676 37.3636 112.592 39.5306C112.508 41.6975 111.219 42.8097 108.743 42.8097C100.141 42.8406 91.5308 42.8097 82.9422 42.8362L76.5471 42.8406Z" fill="#271E63" />
                    </svg>
                </div>
                <h4 class="free-product-title">1. ЗАПОЛНИТЕ ОНЛАЙН ФОРМУ</h4>
                <p class="free-product-desc">
                    Первый шаг для получения БЕСПЛАТНОГО ПРОДУКТА - это заполнение формы на этой странице.
                    Предложение действительно только
                    для клиентов, купивших товар по полной цене у нашего официального продавца на Amazon.com.
                </p>
            </div>
            <div class="free-product">
                <div class="product-icon">
                ...
                <h4 class="free-product-title">2. ПОДЕЛИТЕСЬ ОПЫТОМ</h4>
                <p class="free-product-desc">
                    После заполнения формы мы спросим вас о вашем опыте использования нашего товара. Отправка вашего
                    отзыва поможет другим
                    клиентам принять более правильное решение о покупке.
                </p>
            </div>
            <div class="free-product">
                <div class="product-icon">
                ...
                <h4 class="free-product-title">3. ПОЛУЧИТЕ ПОДАРОК</h4>
                <p class="free-product-desc">
                    Если вы претендуете на отличный ПОДАРОК, мы отправим его в течение 48 часов. Да, мы оплатим
                    товар, а также доставку -
                    для Вас это ноль!
                </p>
            </div>
        </div>
    ...
    <div class="container">
        <h3 class="content-title content-title33 content-title-extra">Бесплатная доставка | Без комиссий | Не
            требуется банковская карта</h3>
        <div class="content-desc">
            <p class="content-desc-txt">* Применяются условия:</p>
            <p class="content-desc-txt">
                Ограничено одним бесплатным продуктом на учетную запись Amazon на семью. Предложение действительно
                только для клиентов,
                которые приобрели наш товар по полной цене у нашего официального продавца на Amazon.com. Чтобы
                пройти квалификацию,
                участники соглашаются отправить нам свой опыт работы с ранее приобретенным продуктом, который они
                активно использовали в
                течение как минимум 14 дней.
            </p>
        </div>
    </div>
    <div class="questions">
        <div class="container">
            ...
            <div class="row question-container">
                <div class="questions-block">
                    <div class="questions-block-title">Это ДЕЙСТВИТЕЛЬНО бесплатно? Или мне нужно платить?</div>
                    <p class="questions-block-desc">
                        Абсолютно никаких оплат. Мы ни в коем случае не запрашиваем данные вашей кредитной карты.
                        Нет пробной версии, подписки,
                        скрытых комиссий и сборов за доставку. Мы покрываем все расходы. Это ДЕЙСТВИТЕЛЬНО
                        БЕСПЛАТНО.
                    </p>
                </div>
                <div class="questions-block">
                    <div class="questions-block-title">В чем подвох? Мне нужно что-то делать?</div>
                    <p class="questions-block-desc">
                        Единственное, о чем мы просим, ​​- это прислать нам свой опыт купленного товара. Обмен вашим
                        опытом поможет нам улучшить
                        наши продукты и поможет другим клиентам принять более правильное решение.
                    </p>
                </div>
                <div class="questions-block">
                    <div class="questions-block-title">Каковы УСЛОВИЯ для участия?</div>
                    <p class="questions-block-desc">
                        Предложение действительно только для клиентов, которые приобрели товар по полной цене на
                        Amazon.com. Вам также
                        необходимо товар не менее 14 дней, прежде чем поделиться своим опытом.
                    </p>
                </div>
                <div class="questions-block">
                    <div class="questions-block-title">Сколько времени потребуется, чтобы получить мой бесплатный
                        товар?</div>
                    <p class="questions-block-desc">
                        Если вы имеете право на БЕСПЛАТНЫЙ продукт, мы отправим его в течение 48 часов. Вы получите
                        товар в течении 20-25
                        рабочих дней.
                    </p>
