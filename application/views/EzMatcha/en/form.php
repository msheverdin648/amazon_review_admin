        ...
        <? if(isset($_SESSION['one_variation']) ): ?>
            <div class="container img--container">
                ...
                <div class="col-lg-8 text-center mx-auto ">
                    <h1 class="main--block__title">Thank you for your purchase!</h1>
                    <h3 class="main--block__subtitle">You purchased this item</h3>
                    <img src="<?=$product['img']?>" alt="Product" class="img-fluid form-img">
                    <p class="main--block__txt"><?=$lang_product['product_en'] ?><br></p>
                    <p class="main--block__txt2">Don't see the item you bought? <a href="#">Contact us at support@eurodo.es</a></p>
                </div>
                
            </div>
            <? endif; ?>
            <h2 class="content-title content-title2">Fill out the form and get your free product</h2>
            <p class="content-txt2">No Shipping Charges | No Hidden Fees | No Credit Card Required</p>
...
<? foreach ($presents as $key => $present) : ?>
                    ...
                    <div class="info-txt d-flex just-between">
                        <div class="left-img">
                            <img src='<?=$baseURL."/img/group.png"?>' alt="" class="group-img hide-img">
                        </div>
                        <p class="left-txt left-txt-desk">
                            * Limited to one free product per Amazon account per household. The offer is only available for customers that purchased the produst at full price through our official seller at Amazon.
                        </p>
                    </div>
                </div>
                <div class="right-block">
                    <form action="<?=$form_link?>" class="form" method='POST' id="form">
                        <input type="text" class="input-item" required name="name" placeholder="Full Name">
                        <input type="email" class="input-item" required name="email" placeholder="e-mail">
                        <p class="input-txt1">* Please input the address where you want the gift to be sent.</p>
                        <input type="text" class="input-item" required name="address" placeholder="Full Address">
                        <input type="text" class="input-item" required name="city" placeholder="City Name">
                        <input type="text" class="input-item" required name="state" placeholder="State / Province">
                        <input type="tel" class="input-item" required name="index" placeholder="Zip Code">
                        ...
                        <input type="tel" class="input-item" required name="phone" placeholder="Phone Number">
                        <input type="text" class="input-item" required name="number" placeholder="Amazon Order #">
                        <p class="input-txt2">
                            * Check in your <a href="#">Amazon Account Order History</a>, in your email or in the receipt you received with your product. E.g. 112-5465666-4343658
                        </p>
...
<? foreach ($presents as $key => $present) : ?>
                        ...
                        <button class="form-btn" type="submit">Get a gift</button>
                        <div class="text-extra">
                            <p class="input-txt1 input-txt3">
                                * We will never share your personal information with anyone. Here is our <a href="#">privacy policy</a>.
                            </p><br/>
                            <p class="input-txt2 input-txt4">
                                * To qualify, participants agree to send us their experience with the previously purchased product that they have been ACTIVELY USING FOR AT LEAST 14 DAYS.
                            </p>
                        </div>
        ...
        <div class="free-product">
            <h2 class="free-product-title">FILL OUT THE FORM AND GET YOUR FREE PRODUCT!!!</h2>
            <div class="row bloook">
                <div class="free-product-item free-product-item1111">
                    ...
                    <h4 class="free-product-item-title">1. FILL IN THE ONLINE FORM</h4>
                    <p class="free-product-desc">
                        The first step to receive your FREE PRODUCT is to complete the form on this page. The offer is valid only for customers that bought the product at full price through our official seller at Amazon.
                    </p>
                </div>
                <div class="free-product-item free-product-item1111">
                    <div class="text-center">
                    ...
                    <h4 class="free-product-item-title">2. SHARE YOUR EXPERIENCE</h4>
                    <p class="free-product-desc">
                        After filling the form we will ask about your experience with our product. Sharing your feedback will help other customers make a better purchase decision.
                    </p>
                </div>
                <div class="free-product-item free-product-item1111">
                    <div class="text-center">
                    ...
                    <h4 class="free-product-item-title">3. RECEIVE A GIFT</h4>
                    <p class="free-product-desc">
                        If you qualify for an Awesome GIFT, we will ship it within 48h. Yes, we will pay for the product and for shipping too - zero cost for you!
                    </p>
                </div>
            </div>
            <h2 class="free-product-title free-product-title2">No Shipping Charges | No Hidden Fees | No Credit Card Required</h2>
            <p class="free-product-text2">
                <span>* Conditions Apply:</span><br/> Limited to one free product per Amazon account per household. The offer is only available for customers that purchased the product at full price through our official seller at Amazon. To qualify, participants
                agree to send us their experience with the previously purchased product that they have been actively using for at least 14 days.
            </p>
        </div>
        <div class="questions">
            <h2 class="quations-title">Frequently Asked Questions</h2>
            <div class="row align-start">
                <div class="questions-item">
                    <h4 class="questions-subtitle">Is it REALLY free? Or do I have to pay?</h4>
                    <p class="questions-text">There are absolutely no charges. We're not asking for your credit card details at any point. There's no trial, no subscription, no hidden fees, no shipping fees. We cover all the costs. This is TRULY FREE.
                    </p>
                </div>
                <div class="questions-item">
                    <h4 class="questions-subtitle">What's the CATCH? Do I need to do something?</h4>
                    <p class="questions-text">
                        The only thing we ask is that you send us your experience with the product. Sharing your experience will help us improve our products and it will help other customers make a better decision.
                    </p>
                </div>
                <div class="questions-item">
                    <h4 class="questions-subtitle">What are the CONDITIONS to qualify?</h4>
                    <p class="questions-text">
                        The offer is only valid for customers who purchased the product at full price on Amazon. You also need to use the product for at least 14 days before sharing your experience.
                    </p>
                </div>
                <div class="questions-item">
                    <h4 class="questions-subtitle">HOW LONG will it take to receive my Free Item?</h4>
                    <p class="questions-text">
                        If you qualify for a FREE product we will ship it within 48h. You will receive the product within 20-25 business days.
                    </p>
                </div>
            </div>
        </div>
