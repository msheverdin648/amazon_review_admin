    ...
    <div class="page3">
        ...
        <form action="<?= $form_link ?>" method="POST" class="feedback-textarea" enctype="multipart/form-data">
            <div class="d-flex choose-container">
                <input name='link' type="text" class="feedback feedback2" placeholder="Paste the link">
                <button type="submit" name='choice' value="link" class="feedback-btn feedback-btn2">Send link</button>
                <!-- <a href="index9.html" class="feedback-btn feedback-btn2">Send link</a> -->
            </div>
        </form>
            ...
            <div class="d-flex choose-container">
                <div class="d-flex">
                    <label class="choose d-flex" for="choose">
                        ...
                        <input name="file" type="file" id="choose" id="choose" class="choose-file">
                        <span>Choose File</span>
                    </label>
                </div>
                <button type="submit" name=choice value="screen" class="feedback-btn feedback-btn2 feedback-btn3">Send screenshot</button>
                <!-- <a href="index9.html" class="feedback-btn feedback-btn2 feedback-btn3">Send screenshot</a> -->
            </div>
        </form>
        <br />
