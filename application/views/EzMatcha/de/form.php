        ...
        <? if(isset($_SESSION['one_variation']) ): ?>
            <div class="container img--container">
                ...
                <div class="col-lg-8 text-center mx-auto ">
                    <h1 class="main--block__title">Vielen Dank für Ihren Kauf!</h1>
                    <h3 class="main--block__subtitle">Sie haben diesen Artikel gekauft</h3>
                    <img src="<?=$product['img']?>" alt="Product" class="img-fluid form-img">
                    <p class="main--block__txt"><?=$lang_product['product_de'] ?><br></p>
                    <p class="main--block__txt2">Merken Sie den Artikel, den Sie gekauft haben, nicht an? <a href="#">Kontaktieren Sie uns unter support@eurodo.es</a></p>
                </div>
                
            </div>
            <? endif; ?>
            <h2 class="content-title content-title2">Füllen Sie das Formular aus und bekommen Sie Ihr kostenloses Produkt</h2>
            <p class="content-txt2">Versandkostenfrei | Provisionsfrei | Keine Kreditkarte benötigt</p>
...
<? foreach ($presents as $key => $present) : ?>
                    ...
                    <div class="info-txt d-flex just-between" style="padding-top: 48px;">
                        <div class="left-img">
                            <img src='<?=$baseURL."/img/group.png"?>' alt="" class="group-img hide-img">
                        </div>
                        <p class="left-txt left-txt-desk">
                            * Beschränkt auf ein kostenloses Produkt pro Amazon-Konto und Haushalt. Das Angebot gilt nur für Kunden, die das Produkt zum vollen Preis über unseren offiziellen Verkäufer bei Amazon gekauft haben.
                        </p>
                    </div>
                </div>
                <div class="right-block">
                <form action="<?=$form_link?>" class="form" method='POST' id="form">
                         <input type="text" class="input-item" required name="name" placeholder="Name">
                        <input type="email" class="input-item" required name="email" placeholder="e-mail">
                        <p class="input-txt1">* Bitte geben Sie die Adresse ein, an die das Geschenk gesendet werden soll.</p>
                        <input type="text" class="input-item" required name="address" placeholder="Adresse">
                        <input type="text" class="input-item" required name="city" placeholder="Stadt">
                        <input type="text" class="input-item" required name="state" placeholder="Provinz">
                       <input type="tel" class="input-item" required name="index" placeholder="PLZ">
                        ...
                        <input type="tel" class="input-item" required name="phone" placeholder="Telefonnummer">
                        <input type="text" class="input-item" required name="number" placeholder="Amazon Bestellnummer">
                        <p class="input-txt2">
                            * Überprüfen Sie den Bestellverlauf Ihres <a href="#">Amazon-Kontos</a>, Ihre E-Mail-Adresse oder die Quittung, die Sie mit Ihrem Produkt erhalten haben. Z.B. 112-5465666-4343658
                        </p>
...
<? foreach ($presents as $key => $present) : ?>
                        ...
                        <button class="form-btn" type="submit">Bekommen Sie ein Geschenk</button>
                        <div class="text-extra">
                            <p class="input-txt1 input-txt3">
                                * Wir werden Ihre persönlichen Daten niemals an Dritte weitergeben. Hier ist unsere <a href="#">Datenschutzerklärung</a>.
                            </p><br/>
                            <p class="input-txt2 input-txt4">
                                * Um sich zu qualifizieren, erklären sich die Teilnehmer damit einverstanden, uns ihre Erfahrungen mit dem zuvor gekauften Produkt zu senden, das sie mindestens 14 Tage lang aktiv verwendet haben.
                            </p>
                        </div>
                        <p class="left-txt left-txt-mobile">
                            * Beschränkt auf ein kostenloses Produkt pro Amazon-Konto und Haushalt. Das Angebot gilt nur für Kunden, die das Produkt zum vollen Preis über unseren offiziellen Verkäufer bei Amazon gekauft haben.
                        </p><input type="hidden" name="language" value="<?=$lang?>">
                    </form>
                </div>
            </div>
        </div>
        <div class="free-product">
            <h2 class="free-product-title">Füllen Sie das Formular aus und bekommen Sie Ihr kostenloses Produkt</h2>
            <div class="row bloook">
                <div class="free-product-item free-product-item1111">
                    ...
                    <h4 class="free-product-item-title">1. FÜLLEN SIE DAS ONLINE-FORMULAR AUS</h4>
                    <p class="free-product-desc">
                        Der erste Schritt, um Ihr KOSTENLOSES PRODUKT zu bekommen, ist das Ausfüllen des Formulars auf dieser Seite. Das Angebot gilt nur für Kunden, die das Produkt zum vollen Preis über unseren offiziellen Verkäufer bei Amazon gekauft haben.
                    </p>
                </div>
                <div class="free-product-item free-product-item1111">
                    <div class="text-center">
                    ...
                    <h4 class="free-product-item-title">2. TEILEN SIE IHRE ERFAHRUNG</h4>
                    <p class="free-product-desc">
                        Nach dem Ausfüllen des Formulars werden wir Sie nach Ihren Erfahrungen mit unserem Produkt fragen. Durch das Teilen Ihres Feedbacks können andere Kunden eine bessere Kaufentscheidung treffen.
                    </p>
                </div>
                <div class="free-product-item free-product-item1111">
                    <div class="text-center">
                    ...
                    <h4 class="free-product-item-title">3. BEKOMMEN SIE EIN GESCHENK</h4>
                    <p class="free-product-desc">
                        Wenn Sie sich für ein fantastisches Geschenk qualifizieren, versenden wir es innerhalb von 48 Stunden. Ja, wir zahlen für das Produkt und auch für den Versand - keine Kosten für Sie!
                    </p>
                </div>
            </div>
            <h2 class="free-product-title free-product-title2">Versandkostenfrei | Provisionsfrei | Keine Kreditkarte benötigt</h2>
        ...
        <div class="questions">
            <h2 class="quations-title">Häufig gestellte Fragen</h2>
            <div class="row align-start">
                <div class="questions-item">
                    <h4 class="questions-subtitle">Ist es wirklich kostenlos? Oder muss ich zahlen?</h4>
                    <p class="questions-text">Es gibt absolut keine Gebühren. Wir fragen zu keinem Zeitpunkt nach Ihren Kreditkartendaten. Es gibt keine Testversion, kein Abonnement, keine versteckten Gebühren, keine Versandkosten. Wir übernehmen alle Kosten. Dies ist wirklich
                        kostenlos.
                    </p>
                </div>
                <div class="questions-item">
                    <h4 class="questions-subtitle">Was ist der Haken? Muss ich etwas tun</h4>
                    <p class="questions-text">Wir bitten Sie lediglich, uns Ihre Erfahrungen mit dem Produkt zuzusenden. Wenn Sie Ihre Erfahrungen teilen, können wir unsere Produkte verbessern und anderen Kunden helfen, eine bessere Entscheidung zu treffen.</p>
                </div>
                <div class="questions-item">
                    <h4 class="questions-subtitle">Was sind die Voraussetzungen, um sich zu qualifizieren?</h4>
                    <p class="questions-text">Das Angebot gilt nur für Kunden, die das Produkt zum vollen Preis bei Amazon gekauft haben. Sie müssen das Produkt mindestens 14 Tage lang verwenden, bevor Sie Ihre Erfahrungen teilen können.</p>
                </div>
                <div class="questions-item">
                    <h4 class="questions-subtitle">Wie lange dauert es, bis ich meinen kostenlosen Artikel bekomme?</h4>
                    <p class="questions-text">Wenn Sie sich für ein KOSTENLOSES Produkt qualifizieren, versenden wir es innerhalb von 48 Stunden. Sie erhalten das Produkt innerhalb von 20-25 Werktagen.</p>
                </div>
            </div>
        </div>
        <footer id="footer">
