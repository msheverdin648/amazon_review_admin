    ...
    <div class="full-page">
        <div class="page">
            <h2 class="title3">Wie würden Sie das Produkt bewerten?</h2>
            ...
            <div class="product-big-img">
                ...
                <h4 class="big-product-title">
                    * Bitte senden Sie Ihr ehrliches Feedback, um Ihr KOSTENLOSES Produkt zu bekommen! <br> * KEINE Kreditkarte oder Zahlungsoption erforderlich, nur Ihre hilfreiche Meinung.
                </h4>
            </div>
