...
?>
    <div class="full-page">
        ...
        <? if(isset($_SESSION['one_variation']) ): ?>
            <div class="container img--container">
                ...
                <div class="col-lg-8 text-center mx-auto ">
                    <h1 class="main--block__title">Grazie per il tuo acquisto!</h1>
                    <h3 class="main--block__subtitle">Hai comprato questo articolo</h3>
                    <img src="<?=$product['img']?>" alt="Product" class="img-fluid form-img">
                    <p class="main--block__txt"><?=$lang_product['product_it'] ?><br></p>
                    <p class="main--block__txt2">
                        Non vedi il prodotto che hai comprato?
                        <a href="#">Contattaci a support@eurodo.es</a>
                    </p>
                </div>
                
            </div>
            <? endif; ?>
            <h2 class="content-title content-title2">Compila il modulo e ottieni il tuo prodotto gratuito</h2>
            <p class="content-txt2">Nessuna spesa di spedizione | Nessun costo nascosto | Non è richiesta la carta di credito</p>
            <div class="d-flex align-start cont">
                ...
                <div class="right-block">
                    <form action="<?=$form_link?>" class="form" method='POST' id="form">
                        <input type="text" class="input-item" required name="name" placeholder="Nome completo">
                        <input type="email" class="input-item" required name="email" placeholder="Indirizzo mail">
                        <p class="input-txt1">* Per favore inserisci l'indirizzo presso cui vuoi che il regalo venga spedito.</p>
                        <input type="text" class="input-item" required name="address" placeholder="Indirizzo completo">
                        <input type="text" class="input-item" required name="city" placeholder="Nome della città">
                        <input type="text" class="input-item" required name="state" placeholder="Stato/Provincia">
                        <input type="tel" class="input-item" required name="index" placeholder="Codice Postale">
                        ...
                        <input type="tel" class="input-item" required name="phone" placeholder="Numero di telefono">
                        <input type="text" class="input-item" required name="number" placeholder="Ordine Amazon">
                        <p class="input-txt2">
                            * Controlla nella cronologia dei tuoi ordini del tuo account di <a href="#">Amazon</a>, nella tua mail o nella ricevuta con il prodotto, es. 112-5465666-4343658
                        </p>
                        ...
                        <button class="form-btn" type="submit">Ottieni un regalo</button>
                        <div class="text-extra">
                            <p class="input-txt1 input-txt3">
                                * Non condivideremo mai le tue informazioni personali con nessuno. Questa è la nostra <a href="#">politica della privacy</a>.
                            </p><br/>
                            <p class="input-txt2 input-txt4">
                                * Per averne diritto, i partecipanti sono d'accordo nell'inviarci la loro esperienza con il loro prodotto precedentemente acquistato che stanno usando in maniera attiva per almeno 14 giorni.
                            </p>
                        </div>
        ...
        <div class="free-product">
            <h2 class="free-product-title">COMPILA IL MODULO E OTTIENI IL PRODOTTO GRATUITO</h2>
            <div class="row bloook">
                <div class="free-product-item free-product-item1111">
                    ...
                    <h4 class="free-product-item-title">1. COMPILA IL MODULO</h4>
                    <p class="free-product-desc">
                        Il primo passo per ricevere il tuo PRODOTTO GRATUITO è compilare tutto il modulo su questa pagina. L'offerta è valida solo per i clienti che hanno acquistato il prodotto a prezzo pieno tramite il nostro venditore ufficiale su Amazon.
                    </p>
                </div>
                <div class="free-product-item free-product-item1111">
                    <div class="text-center">
                    ...
                    <h4 class="free-product-item-title">2. CONDIVIDI LA TUA ESPERIENZA</h4>
                    <p class="free-product-desc">
                        Dopo aver completato il modulo ti chiederemo la tua esperienza con il nostro prodotto. Nel condividere la tua opinione aiuterai gli altri clienti a prendere una migliore decisione.
                    </p>
                </div>
                <div class="free-product-item free-product-item1111">
                    <div class="text-center">
                    ...
                    <h4 class="free-product-item-title">3. RICEVI UN REGALO</h4>
                    <p class="free-product-desc">
                        Se ti candidi per un fantastico REGALO, te lo spediremo entro 48 ore. Sì, pagheremo il prodotto e anche la spedizione, zero costi per te!
                    </p>
                </div>
            </div>
            <h2 class="free-product-title free-product-title2">Nessuna spesa di spedizione | Nessun costo nascosto | Non è richiesta la carta di credito</h2>
        ...
        <div class="questions">
            <h2 class="quations-title">Domande piú frequenti</h2>
            <div class="row align-start">
                <div class="questions-item">
                    <h4 class="questions-subtitle">È davvero gratuito? O devo pagare?</h4>
                    <p class="questions-text">Non ci sono assolutamenti costi aggiunti. Non ti chiediamo per nessun motivo i dettagli della tua carta di credito. Nessuna prova, nessun abbonamento, nessun costo nascosto, nessun costo di spedizione. Copriamo tutti i costi. Questo
                        è VERAMENTE GRATUITO.
                    </p>
                </div>
                <div class="questions-item">
                    <h4 class="questions-subtitle">Cos'è il "CATCH"? Devo fare qualcosa?</h4>
                    <p class="questions-text">
                        L'unica cosa che ti chiediamo è di inviarci la tua esperienza con il prodotto. Nel condividere la tua esperienza ci aiuterai nel migliorare i nostri prodotti e ciò aiuterà gli altri clienti a prendere una migliore decisione.
                    </p>
                </div>
                <div class="questions-item">
                    <h4 class="questions-subtitle">Quali sono le CONDIZIONI per averne diritto?</h4>
                    <p class="questions-text">
                        L'offerta è disponibile solo per i clienti che hanno acquistato il prodotto a prezzo pieno su Amazon. Devi inoltre usare il prodotto per almeno 14 giorni prima di condividere la tua esperienza.
                    </p>
                </div>
                <div class="questions-item">
                    <h4 class="questions-subtitle">QUANTO ci metterò a ricevere il mio articolo gratuito?</h4>
                    <p class="questions-text">
                        Se ti candidi per un prodotto GRATUITO te lo manderemo in 48 ore. Riceverai il prodotto entro 20-25 giorni lavorativi.
                    </p>
                </div>
            </div>
        </div>
