    ...
    <div class="full-page">
        ...
        <div class="content">
            ...
            <div class="container text-center">
                <h2 class="content-title">Quel produit avez-vous acheté ?</h2>
                <p class="content-desc">Acheté des produits peu ou pas appropriés? <a href="#">Contactez-nous chez support@eurodo.es</a></p>
            </div>
        ...
        <div class="just-text">
            <div class="container">
                <h4 class="title">Livraison gratuite | Sans commissions | Carte bancaire non requise</h4>
                <p class="teext">
                    <span>* Les conditions s’appliquent: </span><br/> Limité par un produit gratuit sur le compte Amazon par la famille. La proposition n'est valable que pour les clients qui ont acheté nos produits de notre vendeur officiel sur Amazon.
                    Pour passer à la qualification du produit, les participants acceptent de nous envoyer leur expérience avec le produit précédemment acquis, qu'ils utilisaient activement pendant au moins 14 jours.
                </p>
            </div>
        </div>
        <footer id="footer">
