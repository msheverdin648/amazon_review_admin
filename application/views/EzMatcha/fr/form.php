        ...
        <? if(isset($_SESSION['one_variation']) ): ?>
            <div class="container img--container">
                ...
                <div class="col-lg-8 text-center mx-auto ">
                    <h1 class="main--block__title">Merci pour votre achat!</h1>
                    <h3 class="main--block__subtitle">Vous avez acheté cet article</h3>
                    <img src="<?=$product['img']?>" alt="Product" class="img-fluid form-img">
                    <p class="main--block__txt"><?=$lang_product['product_fr'] ?><br></p>
                    <p class="main--block__txt2">
                        Acheté des produits peu ou pas appropriés?
                        <a href="#">Contactez-nous chez support@eurodo.es</a>
                    </p>
                </div>
                
            </div>
            <? endif; ?>
            <h2 class="content-title content-title2">Remplissez le formulaire et obtenez votre produit gratuit</h2>
            <p class="content-txt2">Livraison gratuite | Sans commissions | Carte bancaire non requise</p>
...
<? foreach ($presents as $key => $present) : ?>
                    ...
                    <div class="info-txt d-flex just-between" style="padding-top: 60px;">
                        <div class="left-img">
                            <img src='<?=$baseURL."/img/group.png"?>' alt="" class="group-img hide-img">
                        </div>
                        <p class="left-txt left-txt-desk">
                            * Limité par un produit gratuit pour un compte Amazon par la famille. La proposition n'est valable que pour les clients qui ont acheté nos produits de notre vendeur officiel sur Amazon.
                        </p>
                    </div>
                </div>
                <div class="right-block">
                <form action="<?=$form_link?>" class="form" method='POST' id="form">
                        <input type="text" class="input-item" required name="name" placeholder="Nom">
                        <input type="email" class="input-item" required name="email" placeholder="e-mail">
                        <p class="input-txt1">* Veuillez entrer l'adresse à laquelle vous souhaitez envoyer un cadeau</p>
                        <input type="text" class="input-item" required name="address" placeholder="Adresse complète">
                        <input type="text" class="input-item" required name="city" placeholder="Ville">
                        <input type="text" class="input-item" required name="state" placeholder="État / province">
                        <input type="tel" class="input-item" required name="index" placeholder="Code postal">
                        <div class="d-flex country-container">
                            <select id="country" class="input-item" name="country">
                                <option>Pays</option>
                        ...
                        <input type="tel" class="input-item" required name="phone" placeholder="Numéro de téléphone">
                        <input type="text" class="input-item" required name="number" placeholder="Numéro de commande Amazon">
                        <p class="input-txt2">
                            * Vérifiez l'historique des commandes dans le compte <a href="#">Amazon</a>, dans votre boîte mail ou votre reçu, obtenu avec le produit. Par exemple 112-5465666-4343658
                        </p>
...
<? foreach ($presents as $key => $present) : ?>
                        ...
                        <button class="form-btn" type="submit">Obtenir un cadeau</button>
                        <div class="text-extra">
                            <p class="input-txt1 input-txt3">
                                * Nous ne partageons jamais vos informations personnelles. Voici notre <a href="#">politique de confidentialité</a>.
                            </p><br/>
                            <p class="input-txt2 input-txt4">
                                * Pour passer à la qualification du produit, les participants acceptent de nous envoyer leur expérience avec le produit précédemment acquis, qu'ils utilisent activement au moins 14 jours.
                            </p>
                        </div>
        ...
        <div class="free-product">
            <h2 class="free-product-title">REMPLISSEZ LE FORMULAIRE ET OBTENEZ VOTRE PRODUIT GRATUIT</h2>
            <div class="row bloook">
                <div class="free-product-item free-product-item1111">
                    ...
                    <h4 class="free-product-item-title">1. REMPLISSEZ LE FORMULAIRE EN LIGNE </h4>
                    <p class="free-product-desc">
                        La première étape pour obtenir UN PRODUIT GRATUIT est de remplir le formulaire sur cette page. L'offre est valable uniquement pour les clients qui ont acheté nos produits au coût de notre vendeur officiel sur Amazon.
                    </p>
                </div>
                <div class="free-product-item free-product-item1111">
                    <div class="text-center">
                    ...
                    <h4 class="free-product-item-title">2. PARTAGEZ VOTRE EXPÉRIENCE</h4>
                    <p class="free-product-desc">
                        Après avoir rempli le formulaire, nous vous demanderons de partager votre expérience d'utilisation de notre produit. L'envoi de votre avis aidera les autres clients à prendre une décision d'achat plus correcte.
                    </p>
                </div>
                <div class="free-product-item free-product-item1111">
                    <div class="text-center">
                    ...
                    <h4 class="free-product-item-title">3. OBTENEZ UN CADEAU </h4>
                    <p class="free-product-desc">
                        Si vous faites une demande pour un CADEAU excellent, nous vous l'enverrons dans les 48 heures. Oui, nous allons payer le produit, ainsi que la livraison - c'est gratuit pour vous!
                    </p>
                </div>
            </div>
            <h2 class="free-product-title free-product-title2">Livraison gratuite | Sans commissions | Carte bancaire non requise</h2>
            <p class="free-product-text2">
                <span>* Les conditions s’appliquent: </span><br/> Limité par un produit gratuit sur le compte Amazon sur la famille. La proposition n'est valable que pour les clients qui ont acheté nos produits à un coût de notre vendeur officiel sur
                Amazon. Pour passer à la qualification du produit, les participants acceptent de nous envoyer leur expérience avec le produit précédemment acquis, qu'ils utilisaient activement pendant au moins 14 jours.
            </p>
        </div>
        <div class="questions">
            <h2 class="quations-title">Questions fréquemment posées</h2>
            <div class="row align-start">
                <div class="questions-item">
                    <h4 class="questions-subtitle">Est-ce que c`est VRAIMENT un bon plan? Ou dois-je payer?</h4>
                    <p class="questions-text">Absolument aucun paiement. Nous ne demandons pas vos données de carte de crédit. Il n'y a pas de version d'évaluation, d'abonnements, de commissions cachées et de frais d'expédition. Nous couvrons tous les coûts. C'est vraiment gratuit.
                    </p>
                </div>
                <div class="questions-item">
                    <h4 class="questions-subtitle">Quel est le PIÈGE? Dois-je faire quelque chose?</h4>
                    <p class="questions-text">
                        La seule chose que nous demandons est de nous envoyer votre expérience des biens achetés. Votre expérience nous aidera à améliorer nos produits et aidera les autres clients à prendre une décision plus correcte.
                    </p>
                </div>
                <div class="questions-item">
                    <h4 class="questions-subtitle">Quelles sont les conditions de participation ?</h4>
                    <p class="questions-text">
                        L'offre n'est valable que pour les clients qui ont acheté nos produits à un coût sur Amazon. Vous devez profiter du produit pendant au moins 14 jours avant de partager votre expérience.
                    </p>
                </div>
                <div class="questions-item">
                    <h4 class="questions-subtitle">Combien de temps faut-il pour obtenir mon produit GRATUIT ?</h4>
                    <p class="questions-text">
                        Si vous avez le droit à un produit gratuit, nous l'enverrons dans les 48 heures. Vous recevrez un produit dans les 20-25 jours ouvrables.
                    </p>
                </div>
            </div>
        </div>
