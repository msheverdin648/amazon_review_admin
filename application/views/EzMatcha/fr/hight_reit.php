...
<div class="full-page">
    ...
    <img src='<?= $baseURL . "/img/Group69.png" ?>' alt="" class="img2 hide-img2">
        ...
        <div class="page3">
            ...
            <h2 class="title3 title5">Merci pour les commentaires sur notre produit!</h2>
            <p class="text4">
            ...
            <div class="d-flex choose-container">
                    <input name='link' type="text" class="feedback feedback2" placeholder="Collez le lien">
                     <button type="submit" name='choice' value="link" class="feedback-btn feedback-btn2">Envoyer le lien</button>
                    <!-- <a href="index9.html" class="feedback-btn feedback-btn2">Envoyer le lien</a> -->
                </div>
                </form>
                <div class="text-or">ou</div>
                <form action="<?= $form_link ?>" method="POST" class="feedback-textarea" enctype="multipart/form-data">
                <div class="d-flex choose-container">
                    <div class="d-flex">
                    ...
                    <button type="submit" name=choice value="screen" class="feedback-btn feedback-btn2 feedback-btn3">Envoyer une capture d'écran</button>
                    <!-- <a href="index9.html" class="feedback-btn feedback-btn2 feedback-btn3">Envoyer une capture d'écran</a> -->
                <input type="hidden" name="language" value="<?= explode('/', $_SERVER['PHP_SELF'])[2]; ?>">
                    </div>
                    </form><br/>
            <div class="title3 title5 step-title">Étape 2. <span>Nous vérifierons l'identifiant de commande que vous avez spécifié pour confirmer l'achat et les commentaires. Si quelque chose ne va pas, nous vous contacterons par courriel.</span>
            </div><br/>
