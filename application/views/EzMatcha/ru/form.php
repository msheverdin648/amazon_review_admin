...
?>
    <div class="full-page">
        ...
        <? if(isset($_SESSION['one_variation']) ): ?>
            <div class="container img--container">
                ...
                <div class="col-lg-8 text-center mx-auto ">
                    <h1 class="main--block__title">Спасибо за покупку!</h1>
                    <h3 class="main--block__subtitle">Вы приобрели этот товар</h3>
                    <img src="<?=$product['img']?>" alt="Product" class="img-fluid form-img">
                    <p class="main--block__txt"><?=$lang_product['product_ru'] ?><br></p>
                    <p class="main--block__txt2">Купили не этот товар? <a href="#">Свяжитесь с нами support@eurodo.es</a></p>
                </div>
                
            </div>
            <? endif; ?>
            <h2 class="content-title content-title2">Заполните форму и получите ваш беспатный продукт</h2>
            <p class="content-txt2">Бесплатная доставка | Без комиссий | Не требуется банковская карта</p>
            <div class="d-flex align-start cont">
                <div class="left-block">
                    ...
                    <div class="info-txt d-flex just-between" style="padding-top: 30px;">
                        <div class="left-img">
                            <img src='<?=$baseURL."/img/group.png"?>' alt="" class="group-img hide-img">
                        </div>
                        
                        <p class="left-txt left-txt-desk">
                            * Ограничено одним бесплатным продуктом на одну учетную запись Amazon на семью. Предложение действительно только для клиентов, которые приобрели товар по полной цене у нашего официального продавца на Amazon.com.
                        </p>
                    </div>
                </div>
                <div class="right-block">
                    <form action="<?=$form_link?>" class="form" method='POST' id="form">
                        <input type="text" class="input-item" required name="name" placeholder="Имя">
                        <input type="email" class="input-item" required name="email" placeholder="e-mail">
                        <p class="input-txt1">* Пожалуйста, введите адрес, по которому вы хотите отправить подарок</p>
                        <input type="text" class="input-item" required name="address" placeholder="Полный адрес">
                        <input type="text" class="input-item" required name="city" placeholder="Город">
                        <input type="text" class="input-item" required name="state" placeholder="Штат / провинция">
                        <input type="tel" class="input-item" required name="index" placeholder="Индекс">
                        <div class="d-flex country-container">
                            <select id="country" class="input-item" class="select-input" name="country">
                        ...
                        <input type="tel" class="input-item" required name="phone" placeholder="Телефонный номер">
                        <input type="text" class="input-item" required name="number" placeholder="№ заказа Amazon">
                        <p class="input-txt2">
                            * Проверьте в <a href="#">Истории Заказов в Аккаунте Амазон</a>, в своей электронной почте или квитанции, полученной вместе с продуктом. Например 112-5465666-4343658
                        </p>
                        ...
                        <div class="text-extra">
                            <p class="input-txt1 input-txt3">
                                * Мы никогда никому не передадим вашу личную информацию. Вот наша <a href="#">политика конфиденциальности</a>.
                            </p><br/>
                            <p class="input-txt2 input-txt4">
                                * Чтобы пройти квалификацию, участники соглашаются присылать нам свой опыт работы с ранее приобретенным продуктом, который они АКТИВНО ИСПОЛЬЗУЮТ НЕ МЕНЕЕ 14 ДНЕЙ.
                            </p>
                        </div>
        ...
        <div class="free-product">
            <h2 class="free-product-title">Заполните форму и получите ваш беспатный продукт</h2>
            <div class="row bloook">
                <div class="free-product-item free-product-item1111">
                    ...
                    <h4 class="free-product-item-title">1. ЗАПОЛНИТЕ ОНЛАЙН ФОРМУ</h4>
                    <p class="free-product-desc">
                        Первый шаг для получения БЕСПЛАТНОГО ПРОДУКТА - это заполнение формы на этой странице. Предложение действительно только для клиентов, купивших товар по полной цене у нашего официального продавца на Amazon.com.
                    </p>
                </div>
                <div class="free-product-item free-product-item1111">
                    <div class="text-center">
                    ...
                    <h4 class="free-product-item-title">2. ПОДЕЛИТЕСЬ ОПЫТОМ</h4>
                    <p class="free-product-desc">
                        После заполнения формы мы спросим вас о вашем опыте использования нашего товара. Отправка вашего отзыва поможет другим клиентам принять более правильное решение о покупке.
                    </p>
                </div>
                <div class="free-product-item free-product-item1111">
                    <div class="text-center">
                    ...
                    <h4 class="free-product-item-title">3. ПОЛУЧИТЕ ПОДАРОК</h4>
                    <p class="free-product-desc">
                        Если вы претендуете на отличный ПОДАРОК, мы отправим его в течение 48 часов. Да, мы оплатим товар, а также доставку - для Вас это ноль!
                    </p>
                </div>
            </div>
            <h2 class="free-product-title free-product-title2">Бесплатная доставка | Без комиссий | Не требуется банковская карта</h2>
        ...
        <div class="questions">
            <h2 class="quations-title">Часто задаваемые вопросы</h2>
            <div class="row align-start">
                <div class="questions-item">
                    <h4 class="questions-subtitle">Это ДЕЙСТВИТЕЛЬНО бесплатно? Или мне нужно платить?</h4>
                    <p class="questions-text">Абсолютно никаких оплат. Мы ни в коем случае не запрашиваем данные вашей кредитной карты. Нет пробной версии, подписки, скрытых комиссий и сборов за доставку. Мы покрываем все расходы. Это ДЕЙСТВИТЕЛЬНО БЕСПЛАТНО. </p>
                </div>
                <div class="questions-item">
                    <h4 class="questions-subtitle">В чем подвох? Мне нужно что-то делать?</h4>
                    <p class="questions-text">Единственное, о чем мы просим, - это прислать нам свой опыт купленного товара. Обмен вашим опытом поможет нам улучшить наши продукты и поможет другим клиентам принять более правильное решение.</p>
                </div>
                <div class="questions-item">
                    <h4 class="questions-subtitle">Каковы УСЛОВИЯ для участия?</h4>
                    <p class="questions-text">Предложение действительно только для клиентов, которые приобрели товар по полной цене на Amazon.com. Вам также необходимо товар не менее 14 дней, прежде чем поделиться своим опытом.</p>
                </div>
                <div class="questions-item">
                    <h4 class="questions-subtitle">Сколько времени потребуется, чтобы получить мой бесплатный товар?</h4>
                    <p class="questions-text">Если вы имеете право на БЕСПЛАТНЫЙ продукт, мы отправим его в течение 48 часов. Вы получите товар в течении 20-25 рабочих дней.</p>
                </div>
            </div>
        </div>
        <footer id="footer">
