        ...
        <div class="form-item" id='opinion'>
          ...
          <div class="input">
            <div class="input__body">
              <input class="input__input" data-required="true" pattern ="^[a-zA-Z0-9]+$" placeholder="ссылка" type="text" value="<? if (isset($opinion)) : ?><?= $opinion ?><? endif; ?>" name="opinion">
            </div>
          </div>
          <? if(isset($message)):?>
            <div class="err_block">
                        ...
                        <div class="form-product__col">
                          ...
                          <div class="form-item">
                            ...
                            <div class="checkbox _checked">
                              <label>
                                <input type="hidden" class="_hidden" name="variate[]" value="<? if ($product['variate']==1) : ?>1<? else : ?>0<? endif; ?>">
                                <input type="checkbox" <? if ($product['variate']==1) : ?>checked<? endif; ?>><span></span>
                      ...
                      <div class="form-product__row">
                        <div class="form-product__col">
                          ...
                          <div class="form-item">
                            ...
                            <div class="checkbox _checked">
                              <label>
                                <input type="hidden" class="_hidden" name="present_var[]" value=" <? if ($present['variate']==1) : ?>1<? else : ?>0<? endif; ?>">
                                <input type="checkbox" <? if ($present['variate']==1) : ?>checked<? endif; ?>><span></span>
                                <div class="checkbox__text">Да</div>
                              </label>
                            </div>
                          </div>
