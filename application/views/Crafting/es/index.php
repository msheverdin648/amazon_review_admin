...
<section class="what-product">
    <div class="container">
        <p class="title upper bs">¿Qué producto ha comprado?</p>
        <p class="text-center">No compró este artículo? <a class="under" href="mailto:support@eurodo.es">Contáctenos en support@eurodo.es</a></p>
        <div class="items">
...
<section class="bottom-text">
    <div class="container px-md-0">
        ...
        <p><b>* Las condiciones se aplican:</b> <br>* Limitado a un producto gratis por cuenta de Amazon por familia. Oferta válida solo para clientes que hayan comprado el artículo a precio completo de nuestro vendedor oficial de Amazon.com.</p>
    </div>
</section>
</main>
